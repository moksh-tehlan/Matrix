...
public class ParserService {
  ...
  public void processDocumentAsync(String bucketName, String key, String knowledgeSourceId) {
    ...
    try {
      ...
      String response =
          lambdaService.invokeLambdaFunction("paperlink-document-parser", jsonPayload);
      ...
      log.info(
          "Document list processing for {} documents took {} ms",
          documentList.size(),
          (documentListTime - startTime));

      // Add to vector DB
      startTime = System.currentTimeMillis();
      vectorService.addVectorData(documentList);
      knowledgeSourceService.updateKnowledgeSourceStatus(
          knowledgeSourceId, ProcessingStatus.COMPLETED);
      ...
      knowledgeSourceService.updateKnowledgeSourceStatus(
          knowledgeSourceId, ProcessingStatus.FAILED);
