...
public class SlackEventService {
  ...
  public boolean processMessageEvent(Map<String, Object> payload, Map<String, Object> event) {
    ...
    try {
      ...
      // Find workspace
      Optional<SlackWorkspaceEntity> workspaceOpt =
          slackWorkspaceRepository.findByWorkspaceId(teamId);
  ...
  public Map<String, Object> processSlashCommand(Map<String, String> payload) {
    ...
    try {
      ...
      switch (command) {
        ...
        default:
          return Map.of("response_type", "ephemeral", "text", "Unknown command: " + command);
      }
    } catch (Exception e) {
      ...
      return Map.of(
          ...
          "ephemeral",
          "text",
          "An error occurred processing your command: " + e.getMessage());
    }
  }
  ...
  private Map<String, Object> handleSearchCommand(String query, String userId, String teamId) {
    ...
    return Map.of(
        "response_type", "in_channel", "text", "*Search Results*: " + query + "\n\n" + response);
  }
  ...
  private Map<String, Object> handleHelpCommand() {
    return Map.of(
        ...
        "ephemeral",
        "text",
        "PaperLink helps you access your organization's knowledge base.\n"
            + "Available commands:\n"
  ...
  private boolean shouldProcessMessage(
      String channel, String eventType, String text, String botUserId) {
    // Direct messages
  ...
  private String getBotUserId(Map<String, Object> payload) {
    ...
    if (payload.containsKey("authorizations")) {
      List<Map<String, Object>> authorizations =
          (List<Map<String, Object>>) payload.get("authorizations");
