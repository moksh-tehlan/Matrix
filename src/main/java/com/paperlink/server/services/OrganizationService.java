...
public class OrganizationService {
   ...
   */
  @Transactional
  public OrganizationEntity createOrganization(
      OrganizationEntity organization, UserEntity adminUser) {
   ...
   */
  @Transactional
  public OrganizationEntity connectSlackWorkspace(
      String organizationId, SlackWorkspaceEntity slackWorkspace) {
    ...
    slackWorkspaceRepository
        .findByWorkspaceId(slackWorkspace.getWorkspaceId())
        .ifPresent(
            existing -> {
