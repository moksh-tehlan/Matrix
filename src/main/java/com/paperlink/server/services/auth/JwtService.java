...
public class JwtService {
  ...
  public String generateAccessToken(UserEntity userEntity) {
    return generateToken(userEntity, accessTokenExpiration, Map.of("tokenType", "access"));
  }
  ...
  public String generateRefreshToken(UserEntity userEntity) {
    return generateToken(userEntity, refreshTokenExpiration, Map.of("tokenType", "refresh"));
  }
  ...
  private String generateToken(
      UserEntity userEntity, long expiration, Map<String, Object> extraClaims) {
    Date now = new Date();
