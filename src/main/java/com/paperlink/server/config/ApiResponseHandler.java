...
/**
 * Global ResponseBodyAdvice to standardize API responses Wraps all controller responses in a
 * consistent ApiResponse object
 */
@ControllerAdvice
@Slf4j
  ...
  public Object beforeBodyWrite(
    ...
    if (body == null) {
      return new ApiResponse<>(
          true, "Operation completed successfully", null, HttpStatus.OK.value());
    }
