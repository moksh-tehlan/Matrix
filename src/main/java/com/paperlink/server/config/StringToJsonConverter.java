 ...
 *
 * <p>This component is needed to properly handle String responses in ResponseBodyAdvice when
 * wrapping them in ApiResponse objects
 */
@Component
...
public class StringToJsonConverter {
   ...
   */
  public void convertToJson(ApiResponse<String> apiResponse, ServerHttpResponse response)
      throws Exception {
  ...
  public ApiResponse<String> createApiResponse(String body) {
    return new ApiResponse<>(true, "Operation completed successfully", body, HttpStatus.OK.value());
  }
}
